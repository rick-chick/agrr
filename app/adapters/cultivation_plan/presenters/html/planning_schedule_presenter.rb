...
class Adapters::CultivationPlan::Presenters::Html::PlanningSchedulePresenter
  ...
  def period_cells(arranged_cultivations:, period_index:)
    Adapters::CultivationPlan::Presenters::Html::ScheduleTableFieldArranger.build_period_cells(

...
module Adapters
  module CultivationPlan
    module Gateways
      class PlanAllocationAllocateAgrrDaemonGateway < Domain::CultivationPlan::Gateways::PlanAllocationAllocateGateway
        def initialize
          @inner = ::Adapters::Agrr::Gateways::PlanAllocationDaemonGateway.new
        end

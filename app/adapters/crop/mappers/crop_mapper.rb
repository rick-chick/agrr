      ...
      class CropMapper
        def self.crop_entity_from_record(crop_model)
          Domain::Crop::Entities::CropEntity.new(
            ...
            associated_pests: map_pest_entities_from_crop_model(crop_model),
        ...
        def self.map_pest_entities_from_crop_model(crop_model)
          assoc = crop_model.association(:pests)
          pest_records =
            if assoc.loaded?
              crop_model.pests.recent.to_a
            else
              crop_model.pests.recent.to_a
            end

          pest_records.map { |pest| pest_entity_from_record(pest) }
        end
        ...
        def self.pest_entity_from_record(model)
          Adapters::Pest::Mappers::PestMapper.pest_entity_from_record(model)
        end

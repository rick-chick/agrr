...
module Adapters
  module Pest
    ...
    class PestUpdateForAiAdapter
      ...
      def initialize(user_id:, gateway:, crop_gateway:, crop_pest_gateway:, logger:, translator:, user_lookup:)
        @user_id = user_id
        @gateway = gateway
      ...
      def build_input_dto(pest_id, attrs)
        ...
        Domain::Pest::Dtos::PestUpdateInput.from_hash(dto_hash, pest_id)
      end

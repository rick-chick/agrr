...
module Adapters
  module WeatherData
    module Gateways
      class WeatherDataActiveRecordGateway
        ...
        def format_for_agrr(weather_data_dtos:, weather_location:)
          wl = weather_location
          Domain::WeatherData::Mappers::OpenMeteoWeatherMapper.format_for_agrr(
        ...
        # @return [Domain::WeatherData::Dtos::WeatherLocation, nil]
        ...
        # @return [Domain::WeatherData::Dtos::WeatherLocation]
        ...
        def update_predicted_weather_data(weather_location_id:, payload:)
          ...
          wl.timezone ||= "UTC"
          wl.update!(predicted_weather_data: Domain::WeatherData::Dtos::PredictedWeatherSnapshot.storage_column_value(payload))

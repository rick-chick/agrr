...
module Adapters
  module InteractionRule
    module Presenters
      class InteractionRuleCreateApiPresenter < Domain::InteractionRule::Ports::InteractionRuleCreateOutputPort
        def initialize(view:)
          @view = view
        end
        ...
        def on_failure(error_dto)
          ...
          if msg == I18n.t("interaction_rules.flash.reference_only_admin")

        ...
        def fetch_crop_info_inner(crop_name, max_retries: DEFAULT_MAX_RETRIES)
          ...
          max_retries.times do |retry_count|
            ...
            begin
              ...
              raise ::Adapters::Agrr::Gateways::DaemonClient::DaemonNotRunningError, "AGRR daemon is not running: #{e.message}"
              ...
              raise ::Adapters::Agrr::Gateways::DaemonClient::CommandExecutionError, "Failed to query crop info from agrr: #{error_msg}"
          ...
          if last_error
            ...
            raise ::Adapters::Agrr::Gateways::DaemonClient::CommandExecutionError, "Failed to query crop info after #{max_retries} attempts"
          end
        end
      end
    end

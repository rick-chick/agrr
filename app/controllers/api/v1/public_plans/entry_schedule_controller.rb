      ...
      class EntryScheduleController < ApplicationController
        ...
        def crops
          ...
          CompositionRoot.entry_schedule_crops_index_interactor(
            output_port: Adapters::PublicPlan::Presenters::EntryScheduleCropsIndexApiPresenter.new(view: self)
          ).call(
            farm: farm,
        ...
        def show
          ...
          crop = @reference_crop
          reference_date = Date.current
          presenter = Adapters::PublicPlan::Presenters::EntryScheduleShowApiPresenter.new(view: self)
        ...
        def resolve_entry_schedule_reference_farm!
          CompositionRoot.entry_schedule_resolve_reference_farm_interactor(
            output_port: Adapters::PublicPlan::Presenters::EntryScheduleResolveReferenceFarmApiPresenter.new(view: self)
          ).call(params[:farm_id])
        end

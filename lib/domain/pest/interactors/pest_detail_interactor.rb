  ...
  module Pest
    module Interactors
      class PestDetailInteractor < Domain::Pest::Ports::PestDetailInputPort
        def initialize(output_port:, user_id:, translator:, show_detail_read_gateway:, user_lookup:)
        ...
        def call(pest_id)
          ...
          show_detail_snapshot = @show_detail_read_gateway.find_show_detail_snapshot(pest_id: pest_id)
          dto = Mappers::PestShowDetailMapper.from_snapshot(show_detail_snapshot)

  ...
  module Crop
    module Interactors
      class CropRegenerateTaskScheduleBlueprintsInteractor
        def initialize(output_port:, user_id:, crop_id:, gateway:, blueprint_creator:, translator:, logger:, user_lookup:)
          @output_port = output_port
          @user_id = user_id
          @crop_id = crop_id
          @gateway = gateway
          @blueprint_creator = blueprint_creator
        ...
        def call
          ...
          @blueprint_creator.regenerate!(crop: crop)
          @output_port.on_success
        rescue Domain::Shared::Policies::PolicyPermissionDenied => e
          @output_port.on_failure(e)
        rescue Domain::Shared::Exceptions::RecordNotFound => e
          @output_port.on_failure(Domain::Shared::Dtos::ErrorDto.new(e.message))
        rescue CropTaskScheduleBlueprintCreateService::MissingCropTaskTemplatesError,

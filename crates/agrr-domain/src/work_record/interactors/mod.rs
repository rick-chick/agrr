...
pub(crate) mod work_record_photo_stale_pending_cleanup_interactor;
...
pub use work_record_photo_stale_pending_cleanup_interactor::WorkRecordPhotoStalePendingCleanupInteractor;

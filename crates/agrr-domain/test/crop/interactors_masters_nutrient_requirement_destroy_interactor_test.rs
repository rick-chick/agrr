// Tests for `interactors/masters_nutrient_requirement_destroy_interactor.rs` (Ruby parity under test/domain/crop/).
    ...
    impl MastersNutrientRequirementOutputPort for Spy {
        fn on_show_success(&mut self, _: crate::crop::entities::NutrientRequirementEntity) {}
        fn on_create_success(&mut self, _: crate::crop::entities::NutrientRequirementEntity) {}
        fn on_update_success(&mut self, _: crate::crop::entities::NutrientRequirementEntity) {}
    ...
    fn destroys_and_reports_success() {
        ...
        let mut i = MastersNutrientRequirementDestroyInteractor::new(&mut out, &crop);

// Tests for `interactors/masters_sunshine_requirement_destroy_interactor.rs` (Ruby parity under test/domain/crop/).
    ...
    impl MastersSunshineRequirementOutputPort for Spy {
        fn on_show_success(&mut self, _: crate::crop::entities::SunshineRequirementEntity) {}
        fn on_create_success(&mut self, _: crate::crop::entities::SunshineRequirementEntity) {}
        fn on_update_success(&mut self, _: crate::crop::entities::SunshineRequirementEntity) {}
    ...
    fn destroys_and_reports_success() {
        ...
        let mut i = MastersSunshineRequirementDestroyInteractor::new(&mut out, &crop);

// Tests for `interactors/masters_thermal_requirement_create_interactor.rs` (Ruby parity under test/domain/crop/).
    ...
    fn sample_input() -> ThermalRequirementUpdateInput {
        ThermalRequirementUpdateInput::new(1, 2, json!({"required_gdd": 200.0}))
    }
    ...
    fn creates_when_absent_and_reports_success() {
        ...
        let mut i =
            MastersThermalRequirementCreateInteractor::new(&mut out, &crop, &req);

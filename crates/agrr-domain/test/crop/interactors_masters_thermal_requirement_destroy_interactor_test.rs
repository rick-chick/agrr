// Tests for `interactors/masters_thermal_requirement_destroy_interactor.rs` (Ruby parity under test/domain/crop/).
    ...
    impl MastersThermalRequirementOutputPort for Spy {
        fn on_show_success(&mut self, _: crate::crop::entities::ThermalRequirementEntity) {}
        fn on_create_success(&mut self, _: crate::crop::entities::ThermalRequirementEntity) {}
        fn on_update_success(&mut self, _: crate::crop::entities::ThermalRequirementEntity) {}
    ...
    fn destroys_and_reports_success() {
        ...
        let mut i = MastersThermalRequirementDestroyInteractor::new(&mut out, &crop);

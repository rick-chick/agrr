ALTER TABLE work_records ADD COLUMN fertilize_id INTEGER REFERENCES fertilizes(id);
ALTER TABLE work_records ADD COLUMN pesticide_id INTEGER REFERENCES pesticides(id);

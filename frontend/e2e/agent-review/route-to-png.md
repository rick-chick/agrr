...
| 22 | `crops/new` | `/crops/new` | yes | `crops_new.ja.png` | `crops_new.en.png` | `crops_new.in.png` |
| 23 | `dashboard` | `/dashboard` | yes | `dashboard.ja.png` | `dashboard.en.png` | `dashboard.in.png` |
| 24 | `farms` | `/farms` | yes | `farms.ja.png` | `farms.en.png` | `farms.in.png` |
| 25 | `farms/:id` | `/farms/1` | yes | `farms_id.ja.png` | `farms_id.en.png` | `farms_id.in.png` |
| 26 | `farms/:id/edit` | `/farms/1/edit` | yes | `farms_id_edit.ja.png` | `farms_id_edit.en.png` | `farms_id_edit.in.png` |
| 27 | `farms/new` | `/farms/new` | yes | `farms_new.ja.png` | `farms_new.en.png` | `farms_new.in.png` |
| 28 | `fertilizes` | `/fertilizes` | yes | `fertilizes.ja.png` | `fertilizes.en.png` | `fertilizes.in.png` |
| 29 | `fertilizes/:id` | `/fertilizes/1` | yes | `fertilizes_id.ja.png` | `fertilizes_id.en.png` | `fertilizes_id.in.png` |
| 30 | `fertilizes/:id/edit` | `/fertilizes/1/edit` | yes | `fertilizes_id_edit.ja.png` | `fertilizes_id_edit.en.png` | `fertilizes_id_edit.in.png` |
| 31 | `fertilizes/new` | `/fertilizes/new` | yes | `fertilizes_new.ja.png` | `fertilizes_new.en.png` | `fertilizes_new.in.png` |
| 32 | `interaction_rules` | `/interaction_rules` | yes | `interaction_rules.ja.png` | `interaction_rules.en.png` | `interaction_rules.in.png` |
| 33 | `interaction_rules/:id` | `/interaction_rules/1` | yes | `interaction_rules_id.ja.png` | `interaction_rules_id.en.png` | `interaction_rules_id.in.png` |
| 34 | `interaction_rules/:id/edit` | `/interaction_rules/1/edit` | yes | `interaction_rules_id_edit.ja.png` | `interaction_rules_id_edit.en.png` | `interaction_rules_id_edit.in.png` |
| 35 | `interaction_rules/new` | `/interaction_rules/new` | yes | `interaction_rules_new.ja.png` | `interaction_rules_new.en.png` | `interaction_rules_new.in.png` |
| 36 | `pesticides` | `/pesticides` | yes | `pesticides.ja.png` | `pesticides.en.png` | `pesticides.in.png` |
| 37 | `pesticides/:id` | `/pesticides/1` | yes | `pesticides_id.ja.png` | `pesticides_id.en.png` | `pesticides_id.in.png` |
| 38 | `pesticides/:id/edit` | `/pesticides/1/edit` | yes | `pesticides_id_edit.ja.png` | `pesticides_id_edit.en.png` | `pesticides_id_edit.in.png` |
| 39 | `pesticides/new` | `/pesticides/new` | yes | `pesticides_new.ja.png` | `pesticides_new.en.png` | `pesticides_new.in.png` |
| 40 | `pests` | `/pests` | yes | `pests.ja.png` | `pests.en.png` | `pests.in.png` |
| 41 | `pests/:id` | `/pests/1` | yes | `pests_id.ja.png` | `pests_id.en.png` | `pests_id.in.png` |
| 42 | `pests/:id/edit` | `/pests/1/edit` | yes | `pests_id_edit.ja.png` | `pests_id_edit.en.png` | `pests_id_edit.in.png` |
| 43 | `pests/new` | `/pests/new` | yes | `pests_new.ja.png` | `pests_new.en.png` | `pests_new.in.png` |
| 44 | `plans` | `/plans` | yes | `plans.ja.png` | `plans.en.png` | `plans.in.png` |

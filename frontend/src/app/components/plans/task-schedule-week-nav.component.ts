  ...
  template: `
    <div class="task-schedule-week-nav">
      <div class="task-schedule-week-nav__modes" role="tablist" aria-label="View mode">
        <button
          type="button"
          class="btn btn-secondary btn-sm task-schedule-week-nav__mode task-schedule-week-nav__mode--plan"
        ...
        <button
          type="button"
          class="btn btn-secondary btn-sm task-schedule-week-nav__mode task-schedule-week-nav__mode--week"

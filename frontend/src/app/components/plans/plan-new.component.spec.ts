...
describe('PlanNewComponent', () => {
  ...
  beforeEach(async () => {
    ...
    translate.setTranslation('en', {
      ...
      'plans.carryover.enabled_label': 'Carry over previous plan learning data',
      'plans.carryover.handoff_hint': 'Apply variance learning from a completed plan.',
      ...
      'plans.carryover.no_source_plans': 'No previous plans found.',
      'plans.carryover.preview_empty': 'No category variance data.',
      'plans.carryover.learn_cta': 'Create and review on Learn',

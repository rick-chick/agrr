      ...
      <section class="section-card" aria-labelledby="plan-context-page-title">
        @if (control.loading) {
          ...
          <app-plan-learn-proposal-queue
            ...
            [stageGddProposals]="control.stageGddProposals"
            [blueprintTimingProposals]="control.blueprintTimingProposals"
            [blueprintAmountProposals]="control.blueprintAmountProposals"
          ...
          <app-blueprint-amount-adjustment-proposals-view
            ...
            [planUnrecordedCount]="control.varianceSummary?.unrecorded_count ?? 0"
            [planActionRequiredCount]="control.varianceSummary?.action_required_items?.length ?? 0"
            [evidenceSources]="control.proposalEvidenceSources"
            (progressChanged)="onProposalProgressChanged()"
          />

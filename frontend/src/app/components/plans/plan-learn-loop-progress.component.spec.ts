...
describe('PlanLearnLoopProgressComponent', () => {
  ...
  it('shows router link to plans/new with carryoverFrom when learning snapshot and carryover sources exist', () => {
    fixture.componentInstance.hasLearningSnapshot = true;
    fixture.componentInstance.carryoverSourcePlanCount = 2;
    fixture.componentInstance.planName = 'Spring 2026';
    fixture.detectChanges();
    ...
    const sourcePlan = fixture.nativeElement.querySelector('.learn-loop-progress__source-plan');
    expect(sourcePlan?.textContent).toContain('Spring 2026');
  });

  ...
  describe('action bar', () => {
    describe('visible range controls', () => {
      it('shows month labels on desktop', () => {
        ...
        const buttons = fixture.nativeElement.querySelectorAll('.gantt-range-controls .btn.btn-secondary');
        ...
        expect(buttons[0].querySelector('.gantt-range-button__icon')).toBeNull();
      });
      ...
      it('shows chevron icons with aria-label on mobile', () => {
        ...
        expect(buttons[0].classList.contains('gantt-range-button--icon')).toBe(true);
        expect(buttons[0].querySelector('.gantt-range-button__icon')).toBeTruthy();
        expect(buttons[1].querySelector('.gantt-range-button__icon')).toBeTruthy();
    ...
    describe('mobile action bar wiring', () => {
      ...
      it('shows labeled crop and field buttons on desktop without mobile menu host', () => {
        ...
        const actionButtons = bar.querySelectorAll('.gantt-action-bar .btn.btn-primary');
        expect(actionButtons.length).toBe(1);
        expect(bar.querySelector('.btn.btn-secondary')).toBeTruthy();
      });

  ...
  template: `
    <div class="page-main">
      @if (control.loading) {
          ...
          <div class="crop-blueprints__plan-wizard-banner" role="status">
            ...
            <div class="blueprint-readiness crop-stages__from-plan-readiness" role="status">
              ...
              <ul class="blueprint-readiness__list">
                <li
                  [class.blueprint-readiness__item--ok]="control.blueprintReadiness.stageRequirementsReady"
                >
                ...
                <li [class.blueprint-readiness__item--ok]="control.blueprintReadiness.fertilizerBlueprintsReady">
                  @if (control.blueprintReadiness.fertilizerBlueprintsReady) {
                    ...
                    <a
                      ...
                      class="blueprint-readiness__link"
                    >
                      {{ 'crops.show.blueprint_readiness.fertilizer_blueprints_action' | translate }}
                    </a>
                  }
                </li>
              </ul>
        ...
        @if (!fromPlanId && control.showBlueprintReadinessChecklist) {

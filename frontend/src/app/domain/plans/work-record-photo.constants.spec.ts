...
describe('work-record-photo.constants', () => {
  ...
  it('defines intrinsic px dimensions matching 4:3 at 16px/rem', () => {
    expect(WORK_RECORD_PHOTO_THUMB_WIDTH_PX_HISTORY).toBe(64);
    expect(WORK_RECORD_PHOTO_THUMB_HEIGHT_PX_HISTORY).toBe(48);
    expect(WORK_RECORD_PHOTO_THUMB_WIDTH_PX_SHEET).toBe(72);
    expect(WORK_RECORD_PHOTO_THUMB_HEIGHT_PX_SHEET).toBe(54);
  });
});

...
const ENTRY_SCHEDULE_UI_KEYS = [
  ...
  'entrySchedule.invalid_farm_id',
  'entrySchedule.selectFarm',
  'entrySchedule.show',
  'entrySchedule.steps.farm',
  'entrySchedule.steps.crop',
  'entrySchedule.summary.farm',
  ...
  'entrySchedule.listEmpty.noCrops.title',
  'entrySchedule.listEmpty.noCrops.description',
  'entrySchedule.listEmpty.noCrops.hint',
  'entrySchedule.listEmpty.noCrops.action',
  'entrySchedule.listEmpty.allIneligible.title',
  'entrySchedule.listEmpty.allIneligible.description',
  'entrySchedule.listEmpty.allIneligible.hint',
  'entrySchedule.listEmpty.allIneligible.action',
  ...
  'entrySchedule.ctaPublicPlan',
  'entrySchedule.ctaCropSetup'
] as const;

...
const PLANS_WORK_RECORDS_KEYS = [
  ...
  'plans.work_records.variance.month_average_on_time',
  ...
  'plans.work_records.photos.close',
  'plans.work_records.photos.prev',
  'plans.work_records.photos.next',
  'plans.work_records.photos.view'
] as const;

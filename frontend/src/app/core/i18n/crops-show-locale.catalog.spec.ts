...
const CROPS_SHOW_KEYS = [
  ...
  'crops.show.cultivation_template_title',
  ...
  'crops.show.blueprint_summary.empty_on_detail',
  ...
  'crops.show.no_stages_description',
  'crops.show.gdd_trigger',
  'crops.show.gdd_trigger_placeholder',
  'crops.show.blueprint_gdd_unset',
  'crops.show.blueprint_gdd_errors.missing_stage',
  'crops.show.blueprint_gdd_errors.stage_gdd_missing',
  'crops.show.blueprint_gdd_errors.out_of_range',
  'crops.show.blueprint_gdd_errors.gdd_required',
  'crops.show.blueprint_stage_lane.unassigned',
  'crops.show.blueprint_stage_lane.unassigned_hint',
  'crops.show.blueprint_stage_lane.gdd_range',
  'crops.show.blueprint_stage_lane.gdd_range_missing',
  'crops.show.blueprint_stage_lane.out_of_range_count',
  'crops.show.blueprint_stage_lane.board_label',
  ...
  'crops.show.blueprint_readiness.field_work_not_required',
  'crops.show.blueprint_readiness.fertilizer_ready',
  'crops.show.blueprint_readiness.fertilizer_missing',
  'crops.show.blueprint_readiness.fertilizer_action',
  ...
  'crops.show.blueprint_readiness.stages_next_step_action',

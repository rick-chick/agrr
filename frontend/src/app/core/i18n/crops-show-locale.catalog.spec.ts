...
const CROPS_SHOW_KEYS = [
  ...
  'crops.show.blueprint_readiness.fertilizer_blueprints_ready',
  'crops.show.blueprint_readiness.fertilizer_blueprints_missing',
  'crops.show.blueprint_readiness.fertilizer_blueprints_action',

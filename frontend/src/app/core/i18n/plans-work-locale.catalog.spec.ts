...
const PLANS_WORK_KEYS = [
  ...
  'plans.work.segment.label',
  'plans.work.segment.all',
  'plans.work.segment.fertilizer',
  'plans.work.segment.pest_control',
  'plans.work.fertilizer_badge.basal',
  'plans.work.fertilizer_badge.topdress',
  'plans.work.pest_control_badge.preventive',
  'plans.work.pest_control_badge.curative',
  'plans.work.harvest_badge.label',
  ...
  'plans.work.today_attention.weather_trigger.frost_forecast',
  'plans.work.today_attention.weather_trigger.gdd_trajectory_delay',
  'plans.work.today_attention.weather_trigger.forecast_sudden_change',
  ...
  'plans.work.today_attention.weather_rationale.forecast_sudden_change',
  'plans.work.today_attention.weather_proposal_cta',
  ...
  'plans.work.mini_climate.title',
  'plans.work.mini_climate.expand',
  'plans.work.mini_climate.collapse',
  'plans.work.mini_climate.loading',
  'plans.work.mini_climate.unavailable',
  'plans.work.mini_climate.cumulative_gdd',
  'plans.work.mini_climate.daily_weather',
  'plans.work.mini_climate.workbench_link',
  ...
  'plans.work.sheet.fertilizer.master_label',
  'plans.work.sheet.fertilizer.master_placeholder',
  'plans.work.sheet.fertilizer.master_empty',
  'plans.work.sheet.fertilizer.master_add_link',
  'plans.work.sheet.pest_control.planned_amount',
  'plans.work.sheet.pest_control.planned_amount_empty',
  'plans.work.sheet.pest_control.actual_amount',
  'plans.work.sheet.pest_control.master_label',
  'plans.work.sheet.pest_control.master_placeholder',
  'plans.work.sheet.pest_control.master_empty',
  'plans.work.sheet.pest_control.master_add_link',
  'plans.work.sheet.pest_control.master_crop_required',
  'plans.work.sheet.harvest.yield_amount',
  'plans.work.sheet.harvest.yield_unit',

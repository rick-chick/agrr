...
const PLANS_TASK_SCHEDULE_KEYS = [
  ...
  'plans.task_schedules.edit_scheduled_date',
  'plans.task_schedules.add_item.title',
  'plans.task_schedules.add_item.field',
  'plans.task_schedules.add_item.field_placeholder',
  'plans.task_schedules.add_item.name',
  'plans.task_schedules.add_item.scheduled_date',
  'plans.task_schedules.add_item.submit',

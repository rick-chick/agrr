...
const PLANS_TASK_SCHEDULE_KEYS = [
  ...
  'plans.task_schedules.page_intro',
  ...
  'plans.task_schedules.fertilizer_empty',
  ...
  'plans.task_schedules.view_mode_plan',
  'plans.task_schedules.view_mode_week',
  'plans.task_schedules.nav_prev_week',
  'plans.task_schedules.nav_next_week',
  'plans.task_schedules.nav_today',
  ...
  'plans.task_schedules.detail.title',
  ...
  'plans.task_schedules.detail.master_name',

...
const PLANS_TASK_SCHEDULE_KEYS = [
  ...
  'plans.task_schedules.filter_category',
  'plans.task_schedules.filter_category_all',
  'plans.task_schedules.filter_category_general',
  'plans.task_schedules.filter_category_fertilizer',
  'plans.task_schedules.filter_category_pest_control',

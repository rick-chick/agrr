...
/** Keys referenced by app-not-found (NotFoundComponent). */
const PAGES_NOT_FOUND_KEYS = [
  'pages.notFound.title',
  'pages.notFound.message',
  'pages.notFound.backHome'
] as const;
...
describe('pages.notFound i18n catalog', () => {
  for (const { name, catalog } of locales) {
    describe(name, () => {
      for (const key of PAGES_NOT_FOUND_KEYS) {
        it(`defines ${key}`, () => {

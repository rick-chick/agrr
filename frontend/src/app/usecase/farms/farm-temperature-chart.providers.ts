...
export const FARM_TEMPERATURE_CHART_PROVIDERS: readonly Provider[] = [
  ...
  {
    provide: LOAD_FARM_TEMPERATURE_CHART_OUTPUT_PORT,
    useExisting: FarmTemperatureChartPresenter
  },
  { provide: FARM_TEMPERATURE_CHART_GATEWAY, useExisting: FarmTemperatureChartApiGateway }
];

export { FarmTemperatureChartPresenter } from '../../adapters/farms/farm-temperature-chart.presenter';

...
### 3. Gateway §P4（adapter 厚み）— **未解消（P6 ルート切替ブロッカー・BC 単位）**
...
| **回答** | **P6 着手の lib/domain ブロッカーはなし**（[`README.md`](../lib-domain-rust/README.md) と一致）。残るのは §3 adapter §P4・§5 `agrr-server` 未作成・BC 単位の R4 |

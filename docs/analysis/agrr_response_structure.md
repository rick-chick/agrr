...
[`lib/domain/agricultural_task/interactors/task_schedule_generate_interactor.rb`](../../lib/domain/agricultural_task/interactors/task_schedule_generate_interactor.rb) の `name_for_blueprint` では：

...
- Before gh issue create: convert issue body 参照 to repository code paths (frontend/..., crates/...) and GitHub #N only — never put tmp/product-gap/ paths in issue bodies (see artifacts.md §起票時の参照変換).

...
class InteractionRuleListPresenterTest < ActiveSupport::TestCase
  test "on_failure renders forbidden for policy" do
    view = Minitest::Mock.new
    presenter = Adapters::InteractionRule::Presenters::Api::InteractionRuleListPresenter.new(view: view)

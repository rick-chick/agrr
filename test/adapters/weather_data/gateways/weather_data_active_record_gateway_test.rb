...
class WeatherDataActiveRecordGatewayTest < ActiveSupport::TestCase
  setup do
    @gateway = Adapters::WeatherData::Gateways::WeatherDataActiveRecordGateway.new
  ...
  test "weather_data_for_period returns DTO array" do
    ...
    assert_instance_of Domain::WeatherData::Dtos::WeatherData, dtos.first
  ...
  test "upsert_weather_data! upserts records" do
    ...
    dtos = attrs.map { |a| Domain::WeatherData::Dtos::WeatherData.from_attrs(a) }

...
module Adapters
  module WeatherData
    module Ports
      class RailsWeatherPredictionAnchorsAdapterTest < ActiveSupport::TestCase
        setup do
          @zone = ActiveSupport::TimeZone["Asia/Tokyo"]
          @adapter = RailsWeatherPredictionAnchorsAdapter.new(zone: @zone)
        end
        ...
        test "anchors_for matches Rails 20.years minus 2 days from reference midnight in zone" do
          ...
          anchors = @adapter.anchors_for(reference)

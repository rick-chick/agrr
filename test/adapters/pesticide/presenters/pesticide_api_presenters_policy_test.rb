...
class PesticideApiPresentersPolicyTest < ActiveSupport::TestCase
  ...
  PESTICIDE_API_PRESENTERS_POLICY_BRANCH = [
    Adapters::Pesticide::Presenters::PesticideListApiPresenter,
    Adapters::Pesticide::Presenters::PesticideDetailApiPresenter,
    Adapters::Pesticide::Presenters::PesticideCreateApiPresenter,
    Adapters::Pesticide::Presenters::PesticideUpdateApiPresenter,
    Adapters::Pesticide::Presenters::PesticideDeleteApiPresenter
  ].freeze
  ...
  test "create presenter on_failure renders forbidden json for reference_only_admin Error" do
    ...
    presenter = Adapters::Pesticide::Presenters::PesticideCreateApiPresenter.new(view: view)

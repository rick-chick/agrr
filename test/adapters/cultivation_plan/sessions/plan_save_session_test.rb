...
class Adapters::CultivationPlan::Sessions::PlanSaveSessionTest < ActiveSupport::TestCase
  def setup
  ...
  test "handles invalid farm_id by capturing RecordNotFound and returning failure result" do
    ...
    result = Adapters::CultivationPlan::Sessions::PlanSaveSession.new(user: @user, session_data: session_data, logger: @plan_save_session_logger, cultivation_plan_gateway: CompositionRoot.cultivation_plan_gateway, crop_stage_copy_gateway: CompositionRoot.crop_stage_copy_gateway).call
    assert_equal false, result.success
  ...
  test "copies crop task schedule blueprints from reference crops to user crops" do
    ...
    second_result = Adapters::CultivationPlan::Sessions::PlanSaveSession.new(user: @user, session_data: session_data, logger: @plan_save_session_logger, cultivation_plan_gateway: CompositionRoot.cultivation_plan_gateway, crop_stage_copy_gateway: CompositionRoot.crop_stage_copy_gateway).call
  ...
  test "reuses existing user farm when same reference farm is copied twice" do
    ...
    first_result = Adapters::CultivationPlan::Sessions::PlanSaveSession.new(user: @user, session_data: session_data, logger: @plan_save_session_logger, cultivation_plan_gateway: CompositionRoot.cultivation_plan_gateway, crop_stage_copy_gateway: CompositionRoot.crop_stage_copy_gateway).call

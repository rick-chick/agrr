...
module Adapters
  module CultivationPlan
    class RestAuthorizedCultivationPlanLoaderTest < ActiveSupport::TestCase
      test "find! public resolves plan visible under public scope" do
        ...
        found = RestAuthorizedCultivationPlanLoader.find!(auth, plan.id)
      ...
      test "find! public raises RecordNotFound when id absent" do
        ...
        assert_raises(ActiveRecord::RecordNotFound) do
          RestAuthorizedCultivationPlanLoader.find!(auth, 9_999_999_999)
        end
      end
      ...
      test "find! public does not expose private plans" do
        ...
        assert_raises(ActiveRecord::RecordNotFound) do
          RestAuthorizedCultivationPlanLoader.find!(auth, plan.id)
        end
      end

...
class Adapters::CultivationPlan::Gateways::PlanAllocationAdjustAgrrDaemonGatewayTest < ActiveSupport::TestCase
  test "maps BaseGatewayV2 ExecutionError to AdjustExecutionError" do
    ...
    gateway = ::Adapters::CultivationPlan::Gateways::PlanAllocationAdjustAgrrDaemonGateway.new

...
class PlanningSchedulePresenterTest < ActiveSupport::TestCase
  ...
  test "period_cells handles single cultivation within a period" do
    ...
    cell = cells.first
    assert_equal :cultivation, cell[Adapters::CultivationPlan::Presenters::ScheduleTableFieldArranger::CELL_TYPE_KEY]
    assert_equal 2, cell[Adapters::CultivationPlan::Presenters::ScheduleTableFieldArranger::CELL_COLSPAN_KEY]
    assert_equal true, cell[Adapters::CultivationPlan::Presenters::ScheduleTableFieldArranger::CELL_RENDER_KEY]
  end
end

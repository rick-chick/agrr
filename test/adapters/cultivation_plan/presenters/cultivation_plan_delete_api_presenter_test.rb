...
class CultivationPlanDeleteApiPresenterTest < ActiveSupport::TestCase
  test "on_success calls view.render_response with ok status and DeletionUndoResponse json" do
    view_mock = mock
    presenter = Adapters::CultivationPlan::Presenters::CultivationPlanDeleteApiPresenter.new(view: view_mock)
    ...
    # Mock DTO
    destroy_output_dto = Domain::CultivationPlan::Dtos::CultivationPlanDestroyOutput.new(undo: event)
  ...
  test "on_failure calls view.render_response with not_found status when plan not found" do
    ...
    error_dto = Domain::Shared::Dtos::Error.new(I18n.t("plans.errors.not_found"))
  ...
  test "on_failure calls view.render_response with unprocessable_entity status when deletion fails" do
    ...
    error_dto = Domain::Shared::Dtos::Error.new(error_message)
  ...
  test "on_failure calls view.render_response with unprocessable_entity status for generic errors" do
    ...
    error_dto = Domain::Shared::Dtos::Error.new("Some other error occurred")

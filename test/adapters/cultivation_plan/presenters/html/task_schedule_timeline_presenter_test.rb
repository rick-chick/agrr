...
class TaskScheduleTimelinePresenterTest < ActiveSupport::TestCase
  ...
  setup do
    ...
    @task_master = Snapshot::AgriculturalTaskRead.new(
      name: "除草作業",
      description: "雑草を取り除く",
    ...
    @schedule = Snapshot::ScheduleRead.new(category: "general", items: [ @item ])
    @task_option = Snapshot::TaskOptionRead.new(
      template_id: 123,
      name: "除草テンプレート",
      task_type: "field_work",
      agricultural_task_id: 42,
  ...
  def presenter_for(dto)
    presenter = Adapters::CultivationPlan::Presenters::Html::TaskScheduleTimelinePresenter.new(view: Object.new, params: {})

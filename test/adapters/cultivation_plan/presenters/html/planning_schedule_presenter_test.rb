...
class PlanningSchedulePresenterTest < ActiveSupport::TestCase
  ...
  test "period_cells returns empty when no cultivations" do
    presenter = Adapters::CultivationPlan::Presenters::Html::PlanningSchedulePresenter.new(periods: build_periods)
  ...
  test "period_cells handles single cultivation within a period" do
    ...
    presenter = Adapters::CultivationPlan::Presenters::Html::PlanningSchedulePresenter.new(periods: periods)
    ...
    cell = cells.first
    assert_equal :cultivation, cell[Adapters::CultivationPlan::Presenters::Html::ScheduleTableFieldArranger::CELL_TYPE_KEY]
    assert_equal 2, cell[Adapters::CultivationPlan::Presenters::Html::ScheduleTableFieldArranger::CELL_COLSPAN_KEY]
    assert_equal true, cell[Adapters::CultivationPlan::Presenters::Html::ScheduleTableFieldArranger::CELL_RENDER_KEY]
  end
end

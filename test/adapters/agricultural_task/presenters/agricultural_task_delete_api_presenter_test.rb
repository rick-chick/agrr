...
class AgriculturalTaskDeleteApiPresenterTest < ActiveSupport::TestCase
  test "on_failure renders forbidden with translated message for policy errors" do
    view_mock = Minitest::Mock.new
    presenter = Adapters::AgriculturalTask::Presenters::AgriculturalTaskDeleteApiPresenter.new(view: view_mock)

...
class AgriculturalTaskDetailPresenterTest < ActiveSupport::TestCase
  test "on_failure renders forbidden with translated message for policy errors" do
    view_mock = Minitest::Mock.new
    presenter = Adapters::AgriculturalTask::Presenters::Api::AgriculturalTaskDetailPresenter.new(view: view_mock)

...
class AgriculturalTaskListApiPresenterTest < ActiveSupport::TestCase
  test "on_failure renders forbidden for policy" do
    view = Minitest::Mock.new
    presenter = Adapters::AgriculturalTask::Presenters::AgriculturalTaskListApiPresenter.new(view: view)

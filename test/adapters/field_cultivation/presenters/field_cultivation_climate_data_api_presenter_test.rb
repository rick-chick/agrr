...
class FieldCultivationClimateDataApiPresenterTest < ActiveSupport::TestCase
  test "on_success renders success payload with status ok" do
    view_mock = mock
    presenter = Adapters::FieldCultivation::Presenters::FieldCultivationClimateDataApiPresenter.new(view: view_mock)
  ...
  test "on_failure renders not_found when message indicates missing data" do
    ...
    failure_dto = Domain::Shared::Dtos::Error.new(error_message)

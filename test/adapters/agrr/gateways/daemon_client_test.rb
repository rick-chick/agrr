...
class AgrrDaemonClientTest < ActiveSupport::TestCase
  def setup
    @service = ::Adapters::Agrr::Gateways::DaemonClient.new
  end
    ...
    File.stub(:exist?, false) do
      File.stub(:socket?, false) do
        ...
        @service.stub(:start_daemon_if_not_running, false) do
          assert_raises(::Adapters::Agrr::Gateways::DaemonClient::DaemonNotRunningError) do
    ...
    File.stub(:exist?, true) do
      File.stub(:socket?, true) do
        Open3.stub(:capture3, lambda do |*args|
          ...
          assert_raises(::Adapters::Agrr::Gateways::DaemonClient::CommandExecutionError) do

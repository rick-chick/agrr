...
class Adapters::PublicPlan::Gateways::EntryScheduleCursorDecodeGatewayTest < ActiveSupport::TestCase
  setup do
    @gateway = Adapters::PublicPlan::Gateways::EntryScheduleCursorDecodeGateway.new
  end

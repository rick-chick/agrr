...
class CropMastersTaskTemplateIndexApiPresenterTest < ActiveSupport::TestCase
  ...
  test "on_failure renders crop not found via api.errors key" do
    ...
    failure_dto = Domain::Crop::Dtos::MastersCropTaskTemplateMastersFailure.new(reason: :crop_not_found)

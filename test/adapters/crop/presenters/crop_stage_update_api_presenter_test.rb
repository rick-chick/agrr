...
class CropStageUpdateApiPresenterTest < ActiveSupport::TestCase
  test "on_success calls view.render_response with ok status and serialized success data" do
    view_mock = mock
    presenter = Adapters::Crop::Presenters::CropStageUpdateApiPresenter.new(view: view_mock)
  ...
  test "on_failure calls view.render_response with unprocessable_entity status and error message" do
    ...
    error_dto = Domain::Shared::Dtos::Error.new("Crop stage update failed")

...
class MastersNestedCropContextPresenterTest < ActiveSupport::TestCase
  test "on_not_found renders default api.errors.crop_not_found" do
    view = mock
    presenter = Adapters::Crop::Presenters::Api::MastersNestedCropContextPresenter.new(view: view)

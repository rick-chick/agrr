...
class CropStageListApiPresenterTest < ActiveSupport::TestCase
  test "on_success calls view.render_response with ok status and serialized success data" do
    view_mock = mock
    presenter = Adapters::Crop::Presenters::CropStageListApiPresenter.new(view: view_mock)
    ...
    success_dto = Domain::Crop::Dtos::CropStageListOutput.new(stages: [ stage_mock ])
  ...
  test "on_success handles empty stages array" do
    ...
    success_dto = Domain::Crop::Dtos::CropStageListOutput.new(stages: [])
  ...
  test "on_failure calls view.render_response with not_found status and error message" do
    ...
    error_dto = Domain::Shared::Dtos::Error.new("Crop not found")

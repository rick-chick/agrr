...
class CropStageDetailApiPresenterTest < ActiveSupport::TestCase
  test "on_success calls view.render_response with ok status and serialized success data" do
    view_mock = mock
    presenter = Adapters::Crop::Presenters::CropStageDetailApiPresenter.new(view: view_mock)
  ...
  test "on_failure calls view.render_response with not_found status and error message" do
    ...
    error_dto = Domain::Shared::Dtos::Error.new("Crop stage not found")

...
class CropStageDeleteApiPresenterTest < ActiveSupport::TestCase
  test "on_success calls view.render_response with ok status and success json" do
    view_mock = mock
    presenter = Adapters::Crop::Presenters::CropStageDeleteApiPresenter.new(view: view_mock)

    success_dto = Domain::Crop::Dtos::CropStageDeleteOutput.new(success: true)
  ...
  test "on_failure calls view.render_response with unprocessable_entity status and error message" do
    ...
    error_dto = Domain::Shared::Dtos::Error.new("Crop stage deletion failed")

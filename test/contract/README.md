...
| `test/contract/**` | P6 R4 ゲート（**対象は agrr-server のみ**）。`contract_test_case.rb` の `rust_*` は Rails API を呼ばない |
| `crates/agrr-r4-contract` | health / cable / AI スモーク（P8.6.1）。auth は **移植不要** — [`P8-RAILS-SHELL-REMOVAL.md`](../docs/migration/app-rust-stack/P8-RAILS-SHELL-REMOVAL.md) |

...
class AgriculturalTaskCreateHtmlPresenterTest < ActiveSupport::TestCase
  ...
  test 'on_success redirects with success notice' do
    ...
    view_mock.expects(:redirect_to).with('/agricultural_tasks/1', notice: I18n.t('agricultural_tasks.flash.created'))

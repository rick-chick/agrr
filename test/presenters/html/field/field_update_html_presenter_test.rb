...
class FieldUpdateHtmlPresenterTest < ActiveSupport::TestCase
  include Rails.application.routes.url_helpers

  test 'on_success redirects with success notice' do
    view_mock = mock
    presenter = Presenters::Html::Field::FieldUpdateHtmlPresenter.new(view: view_mock)
    ...
    view_mock.expects(:redirect_to).with('/farms/1/fields/2', notice: I18n.t('fields.flash.updated'))

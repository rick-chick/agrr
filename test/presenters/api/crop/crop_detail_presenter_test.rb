...
require_relative "../../../../lib/presenters/api/crop/crop_detail_presenter"

class CropDetailPresenterTest < ActiveSupport::TestCase
  test "on_success calls view.render_response with ok status and serialized crop" do
    view_mock = Minitest::Mock.new
    presenter = Presenters::Api::Crop::CropDetailPresenter.new(view: view_mock)

...
module Domain
  module Crop
    module Interactors
      class CropNestedCropTaskTemplatesNewInteractorTest < ActiveSupport::TestCase
        setup do
          @gateway = mock
          @output_port = mock
          @user_lookup = mock
        ...
        test "calls on_success with picklist rows" do
          input_dto = Domain::Crop::Dtos::CropNestedCropTaskTemplatesNewInputDto.new(user_id: 1, crop_id: 2)
          user = mock

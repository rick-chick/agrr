    ...
    module Interactors
      class MastersNutrientRequirementShowInteractorTest < DomainLibTestCase
        setup do
          ...
          @interactor = MastersNutrientRequirementShowInteractor.new(
      ...
      class MastersNutrientRequirementCreateInteractorTest < DomainLibTestCase
        setup do
          ...
          @mock_requirement_gateway = mock
          @mock_output_port = mock
          @interactor = MastersNutrientRequirementCreateInteractor.new(
            output_port: @mock_output_port,
            gateway: @mock_gateway,
            requirement_gateway: @mock_requirement_gateway
          )
      ...
      class MastersNutrientRequirementUpdateInteractorTest < DomainLibTestCase
        setup do
          ...
          @mock_requirement_gateway = mock
          @mock_output_port = mock
          @interactor = MastersNutrientRequirementUpdateInteractor.new(
            output_port: @mock_output_port,
            gateway: @mock_gateway,
            requirement_gateway: @mock_requirement_gateway
          )
      ...
      class MastersNutrientRequirementDestroyInteractorTest < DomainLibTestCase
        setup do
          @mock_gateway = mock
          @mock_output_port = mock
          @interactor = MastersNutrientRequirementDestroyInteractor.new(
            output_port: @mock_output_port,
            gateway: @mock_gateway
          )
        end

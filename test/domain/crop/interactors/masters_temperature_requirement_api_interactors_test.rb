    ...
    module Interactors
      class MastersTemperatureRequirementShowInteractorTest < DomainLibTestCase
        ...
        test "renders show success when requirement exists" do
          ...
          @mock_gateway.expects(:find_temperature_requirement_by_crop_stage_id).with(9).returns(entity)
        ...
        test "renders not found when requirement missing" do
          ...
          @mock_gateway.expects(:find_temperature_requirement_by_crop_stage_id).with(9).returns(nil)
      ...
      class MastersTemperatureRequirementCreateInteractorTest < DomainLibTestCase
        ...
        test "creates when absent and reports success" do
          ...
          @mock_gateway.expects(:find_temperature_requirement_by_crop_stage_id).with(2).returns(nil)
        ...
        test "reports already exists when requirement present" do
          ...
          @mock_gateway.expects(:find_temperature_requirement_by_crop_stage_id).with(2).returns(mock)
      ...
      class MastersTemperatureRequirementUpdateInteractorTest < DomainLibTestCase
        ...
        test "updates when present" do
          ...
          @mock_gateway.expects(:find_temperature_requirement_by_crop_stage_id).with(2).returns(existing)

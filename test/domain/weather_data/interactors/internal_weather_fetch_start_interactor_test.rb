...
module Domain
  module WeatherData
    module Interactors
      class InternalWeatherFetchStartInteractorTest < DomainLibTestCase
        setup do
        ...
        test "completed maps snapshot to success dto" do
          ...
          @presenter.expects(:on_success).with do |dto|
            dto.is_a?(Dtos::InternalWeatherFetchStartOutput) &&
              dto.variant == Dtos::InternalWeatherFetchStartOutput::VARIANT_ALREADY_COMPLETED &&
              dto.farm_id == 42 &&
        ...
        test "started maps snapshot to success dto" do
          ...
          @presenter.expects(:on_success).with do |dto|
            dto.is_a?(Dtos::InternalWeatherFetchStartOutput) &&
              dto.variant == Dtos::InternalWeatherFetchStartOutput::VARIANT_FETCH_STARTED &&
              dto.farm_id == 42 &&
